...
import 'DepressionQuestionBase.dart';

class DepressionQuestionWidget extends StatefulWidget {
  const DepressionQuestionWidget({Key? key}) : super(key: key);
...
class _DepressionQuestionWidgetState extends State<DepressionQuestionWidget> {
  ...
  Widget build(BuildContext context) {
    final question = DepressionQuestions.questions[currentQuestionIndex];
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: (currentQuestionIndex + 1) /
                              DepressionQuestions.questions.length,
            ...
            child: Row(
              ...
              children: [
                ...
                if (currentQuestionIndex <
                    DepressionQuestions.questions.length - 1)
                  ElevatedButton(
                    onPressed: () {
